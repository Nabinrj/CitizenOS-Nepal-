...
const services = [
  ...
  ["AI Assistant", "Ask what service you need and check requirements", "/dashboard/assistant"],
...
const quickActions = [
  ["Ask CitizenOS AI", "/dashboard/assistant"],
  ...
  return <main style={{ minHeight: "100vh", background: "#f8fafc", fontFamily: "system-ui" }}>
    <div style={{ maxWidth: 1180, margin: "0 auto", padding: "28px 24px 48px" }}>
      ...
      <section style={{ marginTop: 28, padding: 24, borderRadius: 20, background: "#0f766e", color: "white" }}>
        ...
        <p style={{ maxWidth: 700, margin: 0, opacity: .9 }}>Start a service, review a credential, ask the AI assistant, or control access to your information without navigating across separate systems.</p>
      </section>
      ...
      <section style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(210px,1fr))", gap: 16, marginTop: 26 }}>
        {services.map(([title, description, href]) => <Link key={href} href={href} style={{ textDecoration: "none", color: "inherit", border: "1px solid #e2e8f0", borderRadius: 16, padding: 20, background: "white" }}>
